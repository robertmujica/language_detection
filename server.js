...
//var encodedURI = URI.serialize(URI.parse(baseURI + "?q=muito praze&key=4392d0dfdf3a7344a500761f34ccf419"));
    ...
    for(var i = 0; i < list.length; i++){
        ...
        request(encodedURI, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                ...
                console.log("Got a response: ", fbResponse.data.detections);
            } else {
